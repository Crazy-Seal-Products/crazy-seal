  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!technician) {
        ...
        setError('You do not have technician access')
        return
      }
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-8">
          <div className="w-14 h-14 rounded-xl bg-[#003365] flex items-center justify-center mb-3">
            <span className="text-white text-lg font-bold">RVA</span>
          </div>
          <h1 className="text-xl font-bold text-gray-900">Technician Training</h1>
