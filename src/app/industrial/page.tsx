...
export const metadata: Metadata = {
  title: 'DIY Industrial Roofing',
  description: 'Seal your own industrial roof with the Crazy Seal DIY Roofing System.',
}
        ...
        <div className="relative section-bleed bg-primary overflow-hidden">
          ...
          <div className="relative z-10 px-5 py-12 sm:px-6 sm:py-14 lg:px-8 lg:py-18 text-center">
            ...
            <p className="text-xl sm:text-2xl font-semibold text-highlight mb-6 max-w-2xl mx-auto">
              Seal your own industrial roof with the Crazy Seal DIY Roofing System.
            </p>
