...
const BADGES = [
  ...
  { image: `${MEDIA}/2019/05/DIY.png`, label: 'Simple Install' },
...
const COMPLETED_ROOFS = [
  { label: 'Aruba', image: `${MEDIA}/2019/07/Square-Aruba-Back-to-Front.jpg` },
  { label: 'Monaco', image: `${MEDIA}/2019/07/Square-Monaco-Front-to-Back.jpg` },
  { label: 'Winnebago', image: `${MEDIA}/2019/07/Square-Winnebago-Back-to-Front.jpg` },
]
...
export default function TransportationPage() {
  return (
    <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 items-center">
              <div className="text-center lg:text-left">
                ...
                <p className="text-white/60 leading-relaxed mb-6 max-w-lg mx-auto lg:mx-0">
                  A permanent, seamless roofing system for tractor trailers, box
                  trucks, delivery vehicles, and fleets — backed by a 50 year
              ...
              <ClickToPlayVideo
                vimeoId="717595036"
                thumbnail="https://i.vimeocdn.com/video/1445939956-3a69ea8d25a2a5b445f99e98907391c10b1e5163a5f774010657c974fee12df2-d_640?region=us"
                title="Crazy Seal for Transportation"
                caption="Click to watch (4:02)"
              />
            </div>
          </div>
        </div>
        ...
        <div className="section-bleed bg-white border-y sm:border border-gray-200/80 px-5 py-6 sm:px-6 md:p-6 lg:p-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-10 items-center">
            <div>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src={`${MEDIA}/2019/07/Square-Monaco-Front-to-Back.jpg`}
                alt="Vehicle roof sealed with Crazy Seal"
                className="rounded-2xl shadow-lg w-full h-auto"
              />
            </div>
            <div>
              <SectionHeading
                heading="Nothing takes a beating like a vehicle roof."
                align="left"
                className="mb-4"
              />
              <p className="text-gray-600 leading-relaxed mb-4">
                Driving a vehicle down the road is like setting off a mini
                earthquake. You want a roof on your vehicle that can handle
                ...
                best roofing system money can buy.
              </p>
              <p className="text-gray-600 leading-relaxed">
                Imagine applying a roofing system to your vehicle that would
                outlast the vehicle itself! The founders of Crazy Seal developed
                our product for the person looking for a permanent, DIY solution
                to their roofing needs. Better by design, our high grade
      ...
      {/* ─── 21½ REASONS + LET'S GET CRAZY ─── */}
      <Container size="xl" className="sm:pt-4 md:pt-8">
        <div className="section-bleed bg-primary overflow-hidden px-5 py-6 sm:px-6 md:p-6 lg:p-8">
          <SectionHeading
            heading="21½ Reasons Why"
            subheading="Watch our 21½ Reasons Why Crazy Seal is a Superior Roofing System video and our Let's Get Crazy video, where we put our products to the ultimate test. We recommend not trying any of these tests at home!"
            variant="dark"
          />
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6">
            ...
            <ClickToPlayVideo
              ...
              caption="Watch this to see our crazy tests (5:24)"
            />
          </div>
        ...
        <div className="section-bleed bg-white border-y sm:border border-gray-200/80 px-5 py-6 sm:px-6 md:p-6 lg:p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-10">
            <div>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src={`${MEDIA}/2020/03/Traditional-Roof-1-1024x576.jpg`}
                alt="Traditional roofing with penetrations"
                className="rounded-2xl shadow-lg w-full h-auto mb-5"
              />
            ...
            <div>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                src={`${MEDIA}/2019/06/047-Apply-Seal-Over-Caulk.jpg`}
                alt="Crazy Seal membrane applied over sealed penetrations"
                className="rounded-2xl shadow-lg w-full h-auto mb-5"
              />
          ...
          <div className="pt-8 md:pt-12">
            ...
            <p className="text-gray-500 text-center max-w-2xl mx-auto mb-6">
              ...
              destructive to your vehicle and everything inside. Here are a few
      ...
      <Container size="xl" className="sm:pt-4 md:pt-8">
        <div className="section-bleed bg-white border-y sm:border border-gray-200/80 px-5 py-6 sm:px-6 md:p-6 lg:p-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-6">
            {COMPLETED_ROOFS.map((roof) => (
              <div key={roof.label}>
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src={roof.image}
                  alt={`Completed Crazy Seal roof — ${roof.label}`}
                  className="rounded-2xl shadow-md w-full h-auto"
                />
                <p className="text-center text-sm font-semibold text-gray-600 mt-2">
                  {roof.label}
