...
export const metadata: Metadata = {
  title: 'DIY Roofing for Tractor Trailers',
  description: 'Seal your own tractor trailer roof with the Crazy Seal DIY Roofing System.',
}
...
export default function TractorTrailersPage() {
  return (
    <>
      {/* ─── HERO ─── */}
      <Container size="xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 items-center">
              <div className="text-center lg:text-left">
                ...
                <p className="text-xl sm:text-2xl font-semibold text-highlight mb-6">
                  Your Tractor Trailer roof will love you when you protect it with Crazy Seal!
                </p>
        ...
        <div className="section-bleed bg-primary overflow-hidden px-5 py-6 sm:px-6 md:p-6 lg:p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6">
            ...
            <div>
              ...
              />
              <p className="text-center text-white/70 text-sm font-medium mt-2">
                Watch This to See Our Crazy Tests (5:24)
              </p>
            </div>
          </div>
      ...
      <Container size="xl" className="sm:pt-4 md:pt-8">
        <div className="section-bleed bg-white border-y sm:border border-gray-200/80 px-5 py-6 sm:px-6 md:p-6 lg:p-8">
          ...
          <p className="text-gray-500 text-center max-w-2xl mx-auto pt-8">
            ...
            destructive to your vehicle and everything inside. Above are a few
