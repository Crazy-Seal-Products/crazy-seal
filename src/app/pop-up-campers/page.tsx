...
export const metadata: Metadata = {
  title: 'DIY Roofing for Pop-Up Campers',
  description: 'Seal your own pop-up camper roof with the Crazy Seal DIY Roofing System.',
}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 items-center">
              <div className="text-center lg:text-left">
                ...
                <p className="text-xl sm:text-2xl font-semibold text-highlight mb-6">
                  Your Pop-Up Camper roof will love you when you protect it with Crazy Seal!
                </p>
