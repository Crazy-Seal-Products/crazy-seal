...
export const metadata: Metadata = {
  title: 'Crazy Seal Roofing Applications',
  description: 'Seal your own roof for less with the Crazy Seal Roofing System.',
}
...
export default function RoofingApplicationsPage() {
  return (
    <>
      {/* ─── HERO ─── */}
      <Container size="xl">
