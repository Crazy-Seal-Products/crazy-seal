  ...
  return (
    <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 items-center">
              <div className="text-center lg:text-left">
                ...
                <p className="text-xl sm:text-2xl font-semibold text-highlight mb-4">
                  RV Roofing Done Right
                </p>
                <p className="text-white/60 leading-relaxed mb-6 max-w-lg mx-auto lg:mx-0">
                  A permanent, DIY, seamless roofing system for RVs, travel
                  trailers, fifth wheels, and motor coaches — backed by a 50
                  year warranty and shipped straight to your door.
                </p>
              ...
              <ClickToPlayVideo
                videoId="lrfVHAG86UE"
                title="The Crazy Seal Roofing System for RV's"
                caption="Click to watch (5:23)"
              />
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-10">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                pharmaceutical industry. That means the tightest tolerances, and
                we put more of the good stuff in our products. No cheap fillers.
              </p>
            </div>
          </div>
        ...
        <div className="section-bleed bg-primary overflow-hidden px-5 py-6 sm:px-6 md:p-6 lg:p-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-10 items-center">
            ...
            <ClickToPlayVideo
              ...
              caption="Click to watch why Crazy Seal is better (10:24)"
            />
          </div>
        </div>
      </Container>
      ...
      <Container size="xl" className="sm:pt-4 md:pt-8">
        <div className="section-bleed bg-primary overflow-hidden px-5 py-6 sm:px-6 md:p-6 lg:p-8">
          <SectionHeading
            ...
            subheading="All Crazy Seal products ship directly to your door. On average, the system ranges between $3.00-$5.00 per square foot of coverage depending on your application and coverage rate. Choose a kit type below to get started."
            variant="dark"
          />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-10">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                penetrations, and that sealant is the only protection. Over
                time it can rot or deteriorate, leaving your roof vulnerable to
                water intrusion.
              </p>
            </div>
            <div>
      ...
      <LeadCaptureSection
        ...
        heading="Talk to a Specialist About Your RV Roof"
        subheading="Tell us about your rig and we'll build the perfect kit with you — no pressure, no obligation."
      />
    </>
  )
}
