...
export const metadata: Metadata = {
  ...
  description:
    'Our most popular kit! The Double Layer Kit gives you everything you need to apply two layers of the entire Crazy Seal system for around 40 mils of seamless membrane protection. In-stock and ready to ship with free shipping on orders over $500.',
}

const KIT_SIZES = [
  {
    label: '0-100 SQ FT',
    image: `${MEDIA}/2019/10/06_Double-0-100-White-1024x351.png`,
    contents: [
  ...
  {
    label: '100-200 SQ FT',
    image: `${MEDIA}/2019/10/07_Double-100-200-White-1024x304.png`,
    contents: [
      '(1) Gallon of Crazy Clean',
      '(1) Tube of Crazy Caulk',
      '(1) Gallon of Crazy Patch',
      '(4) Gallons of Crazy Seal',
    ],
  },
  {
    label: '200-300 SQ FT',
    image: `${MEDIA}/2019/10/08_Double-200-300-White-1024x336.png`,
    contents: [
      '(1) Gallon of Crazy Clean',
      '(1) Tube of Crazy Caulk',
      '(1) Gallon of Crazy Patch',
      '(6) Gallons of Crazy Seal',
    ],
  },
  {
    label: '300-400 SQ FT',
    image: `${MEDIA}/2020/03/400-White-Tiny-1024x484.png`,
    contents: [
      '(1) Gallon of Crazy Clean',
      '(2) Tubes of Crazy Caulk',
      '(1) Gallon of Crazy Patch',
      '(8) Gallons of Crazy Seal',
    ],
  },
  {
    label: '400-500 SQ FT',
    image: `${MEDIA}/2019/10/09_Double-300-500-White-1024x485.png`,
    contents: [
      '(1) Gallon of Crazy Clean',
      '(1) Tube of Crazy Caulk',
      '(1) Gallon of Crazy Patch',
      '(10) Gallons of Crazy Seal',
    ],
  },
]
...
export default function DoubleLayerKitPage() {
  return (
    <>
      {/* ─── HERO ─── */}
      <Container size="xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 items-center">
              <div className="text-center lg:text-left">
                ...
                <p className="text-base sm:text-lg text-white/70 font-semibold mb-3">
                  Our &ldquo;Double Layer Kit&rdquo; gives you everything you
                  need to apply two layers of the entire Crazy Seal system.
                </p>
                <p className="text-white/60 leading-relaxed mb-6">
                  Double Layer Kits come with enough Crazy Caulk and Crazy
                  Patch to seal your penetrations, as well as enough Crazy Seal
                  to apply two layers of the Crazy Seal Roof Membrane.
                </p>
              ...
              <VideoPlayer
                youtubeId="DUt04pcOCYw"
                title="Double Layer Kit product video"
                caption="Click to Watch Product Video (1:23)"
              />
            </div>
          </div>
        </div>
            ...
            {KIT_SIZES.map((kit) => (
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-[1.5fr_1fr] gap-6 items-center">
                  ...
                  <img
                    src={kit.image}
                    alt={`Double Layer Kit ${kit.label} contents`}
        ...
        <div className="section-bleed bg-white border-y sm:border border-gray-200/80 px-5 py-6 sm:px-6 md:p-6 lg:p-8">
          <div className="max-w-3xl mx-auto text-center md:text-left">
            <h2 className="text-2xl sm:text-3xl font-bold text-primary tracking-tight uppercase mb-4">
              Double Layer Kit (Most Popular)
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Our &ldquo;Double Layer Kit&rdquo; gives you everything you need
              to apply two layers of the entire Crazy Seal system.
            </p>
            <p className="text-gray-600 leading-relaxed mb-4">
              Double Layer Kits come with enough Crazy Caulk and Crazy Patch to
              seal your penetrations, as well as enough Crazy Seal to apply two
              layers of the Crazy Seal Roof Membrane. Kits are calculated by
              square footage at 100 SQ FT of coverage to the gallon.
            </p>
            <p className="text-gray-600 leading-relaxed mb-4">
              This kit will leave you with about 20 mils of thickness per layer
              on your overall membrane for a total of around 40 mils, but
              thicker in areas where you put down caulk and mastic to seal the
              seams and penetrations.
            </p>
            <p className="text-gray-600 leading-relaxed mb-6">
              We recommend our &ldquo;Double Layer System&rdquo; in most
              instances because most of us aren&apos;t perfect installers. We
              like the second layer of Crazy Seal to go down to ensure proper
              coverage. This second membrane layer will increase your total
              millage from 20 to 40 mils, with the seamless membrane being
              thicker in areas where Crazy Caulk and Crazy Patch are applied.
            </p>
            <LinkButton href={SHOP_KIT} variant="accent" size="md" external>
              <ShoppingCart className="w-4 h-4" />
              Shop the Double Layer Kit
            </LinkButton>
          </div>
        </div>
      </Container>
      ...
      <Container size="xl" className="sm:pt-4 md:pt-8">
        <div className="section-bleed bg-white border-y sm:border border-gray-200/80 px-5 py-6 sm:px-6 md:p-6 lg:p-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {INSTALLATION_EXAMPLES.map((example, i) => (
              <div key={`${example.label}-${i}`}>
                <BeforeAfterSlider
