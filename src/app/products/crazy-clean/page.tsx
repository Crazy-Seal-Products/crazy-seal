...
const SHOP_URL = 'https://buy.crazyseal.com/products/crazy-clean'

export const metadata: Metadata = {
  title: 'Crazy Clean',
  description:
    'Crazy Clean is a highly effective concentrated cleaning solution specially formulated to remove surface contaminants such as oils, dirt and oxidation. Environmentally safe and non-toxic. Cleans up to 1,000 SQ FT per gallon.',
}

export default function CrazyCleanPage() {
  return (
    <>
      {/* ─── HERO ─── */}
      <Container size="xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 items-center">
              <div className="text-center lg:text-left">
                ...
                <p className="text-base sm:text-lg text-white/70 leading-relaxed mb-6">
                  A highly effective concentrated cleaning solution specially
                  formulated to remove surface contaminants such as oils, dirt
                  and oxidation.
                </p>
              ...
              <VideoPlayer
                ...
                title="Crazy Clean product video"
                caption="Click to Watch Product Video (0:26)"
              />
            </div>
          </div>
        </div>
        ...
        <div className="section-bleed bg-white border-y sm:border border-gray-200/80 px-5 py-6 sm:px-6 md:p-6 lg:p-8">
          <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-6 lg:gap-10 items-center">
            <div className="flex items-center justify-center">
              ...
              <img
                src={`${MEDIA}/2019/05/Crazy-Clean.png`}
                alt="Crazy Clean 1 gallon jug"
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                Crazy Clean is a highly effective concentrated cleaning
                solution specially formulated to remove surface contaminants
                such as oils, dirt and oxidation. Crazy Clean is
                environmentally safe, non-toxic and leaves no contaminating
                by-products or pollutants to damage the environment.
              </p>
              <p className="text-gray-600 leading-relaxed mb-4">
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                ...
                Because this is a concentrated solution, you can expect to
                clean up to 1,000 SQ FT with 1 gallon of Crazy Clean mixed with
                3 gallons of water.
              </p>
