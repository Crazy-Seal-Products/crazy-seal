  ...
  return (
    <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 items-center">
              <div className="text-center lg:text-left">
                ...
                <p className="text-white/60 leading-relaxed mb-6 max-w-lg mx-auto lg:mx-0">
                  A permanent, DIY, seamless roofing system for flat residential
                  roofs, sunrooms, porches, and storage buildings — backed by a
                  50 year warranty and shipped straight to your door.
                </p>
              ...
              <ClickToPlayVideo
                videoId="ji0GvXRUams"
                title="The Crazy Seal DIY Roofing System"
                caption="Click to watch (5:15)"
              />
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-10 items-center">
            <div>
              ...
              <img
                ...
                alt="Residential sunroom roof sealed with Crazy Seal"
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                The founders of Crazy Seal developed our product for the person
                looking for a permanent, DIY solution to their roofing needs.
      ...
      <Container size="xl" className="sm:pt-4 md:pt-8">
        <div className="section-bleed bg-white border-y sm:border border-gray-200/80 px-5 py-6 sm:px-6 md:p-6 lg:p-8">
          <SectionHeading
            ...
            heading="Residential Transformations"
            subheading="All components merge seamlessly together into a single membrane. Slide the center bar back and forth to discover how Crazy Seal creates a seamless membrane on every inch of your roof."
          />
      ...
      <LeadCaptureSection
        ...
        defaultProjectType="Residential Flat Roof"
        heading="Talk to a Specialist About Your Residential Roof"
      />
    </>
  )
}
